...
async function transferData(batchSize = 50000, parallelism = 1) {
    ...
    try {
        ...
        // Disable foreign key checks and indexes in the target database
        await targetConnection.query('SET foreign_key_checks = 0;');
        // Optionally, disable indexes
        // await targetConnection.query('ALTER TABLE <targetTable> DISABLE KEYS;');
...
// Run the transfer function with a batch size of 10000 and parallelism of 4 for testing
transferData(50000, 1);
