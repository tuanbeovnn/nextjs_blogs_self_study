    ...
    <RequiredAuthPage>
      <div className="max-w-7xl mx-auto md:px-8 px-4">
        <div className="flex flex-col gap-y-5 max-w-[845px] mx-auto mt-5 mb-10">
          <div className="border border-solid border-gray-300 dark:border-borderDark rounded-lg flex item-center justify-center p-5">
          ...
          <div className="border border-solid border-gray-300 dark:border-borderDark rounded-lg flex flex-col gap-y-6 item-center p-5">
