		...
		<RequiredAuthPage>
			<div className="max-w-5xl mx-auto p-8 my-5">
				...
				<form onSubmit={handleSubmit(onSubmit)}>
					<InputHook control={control} name="title" placeholder="Enter title" id="title" type="text"
					           label="Post Title"/>
					<InputHook control={control} name="shortDescription" placeholder="Enter short description"
					           id="shortDescription" type="text" label="Short Description"/>
					<div className="mb-5">
							...
							{tags.map((tag, index) => (
								<span key={index}
									...
									<button type="button"
									        ...
									        aria-label="Remove" onClick={() => removeTag(tag)}>
