...
function Register() {
    ...
    const { handleSubmit, formState: { errors, isSubmitting, isValid }, reset, setFocus, control } = useForm<FormValues>({ resolver, mode: "onChange" });
        ...
        <div className="max-w-7xl mx-auto md:px-8 px-4">
            <div className="max-w-md mx-auto my-6 w-full bg-white rounded-lg shadow-inner p-6">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <InputHook control={control} name="fullname" placeholder="Your Full Name" id="fullname" type="text" label="Full Name" />
