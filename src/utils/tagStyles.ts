...
export const tagStyles: { [key: string]: string } = {
    ...
    WEB: "bg-red-100 text-red-800 dark:text-gray-400 border border-gray-400",
    IT: "bg-green-100 text-green-800 dark:text-green-400 border border-green-400",
    AI: "bg-blue-100 text-blue-800 dark:text-blue-400 border border-blue-400",
    MOBILE: "bg-yellow-100 text-yellow-800 dark:text-yellow-300 border border-yellow-300",
