    ...
    return (
        <div className="mb-4">
            ...
            <select
                {...field}
                {...props}
                className={`shadow appearance-none border rounded w-full p-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${fieldState.error ? 'border-red-500' : 'border-gray-300'}`}
            >
