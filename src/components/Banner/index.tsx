    ...
    return (
        <section className="mt-2.5 mb-4 md:mb-16">
            <div className="max-w-7xl mx-auto md:px-8 px-4 md:pt-4">
                ...
                >
                    <div className="bg-white p-10 rounded-xl dark:bg-heading shadow-box border border-borderLight dark:border-borderDark w-[598px] hidden md:block ml-16 -mb-16">
                        <Badge label="Technology" />
                        <h1 className="text-3xl leading-10 dark:text-white text-heading font-semibold mt-4 mb-6 line-clamp-3 no-underline hover:underline cursor-pointer">
