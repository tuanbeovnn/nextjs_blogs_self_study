...
const Logo = ({
  ...
  return (
    <div
      className={`text-heading flex-shrink-0 flex items-center justify-center gap-3 ${className}`}
    >
      <svg
      ...
      <div className={"text-heading dark:text-white"}>
        <div className="text-xl">
          Meta<span className="font-bold">Blog</span>
        </div>
        <div className={`${kind === "header" ? "hidden" : "block"}`}>
